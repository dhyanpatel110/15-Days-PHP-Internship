    	...
    	<div class="container">
    		<div class="mail_section">
    			<ul>
    				...
    				<li class="footer-logo"><img src="images/map-icon.png"><span class="map_text">32 west mumbai india</span></li>
    				<li class="footer-logo"><img src="images/call-icon.png"><span class="map_text">(+91) 8200299400</span></li>
    				<li class="footer-logo"><img src="images/email-icon.png"><span class="map_text">Dog @gmail.com</span></li>
    			</ul>
    	    </div> 
